package casinoPages.slovak_casino.tipSportPages;
...
import static webTDK.constants.EnvironmentUrls.TIPSPORT_URL;

public class TipSportLandingPage extends PageBase {
    public TipSportLandingPage(){
    ...
    @FindBy(xpath = ".//a[@data-atid = \"mainTab-CASINO\"]")
    ...
    public void openTipSportLandingPage(){
        this.driver.get(TIPSPORT_URL);
    }
